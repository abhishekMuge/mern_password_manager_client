  ...
  return (
    <div className="flex flex-col w-64 h-screen px-4 py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600">
      ...
      <div className="flex flex-col justify-between flex-1 mt-6">
        <nav>
          <div className="flex items-center px-4 py-2 text-gray-700 bg-gray-200 rounded-md dark:bg-gray-700 dark:text-gray-200">
            <svg
              className="w-5 h-5"
              viewBox="0 0 24 24"
              fill="none"
            ...
            <Link href="/dashboard" className="mx-4 font-medium">
              All password
            </Link>
          </div>
          <div className="cursor-pointer flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-200 transform rounded-md dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6"
              fill="none"
            ...
            <Link href="shared-password" className="mx-4 font-medium">
              Shared
            </Link>
          </div>
